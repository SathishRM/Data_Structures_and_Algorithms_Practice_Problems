...
where customers[i] = [arrival(i), time(i)]:
...
The customer waits till the chef finishes preparing his order. The chef does not prepare food
for more than one customer at a time. The chef prepares food for customers in the order they
...
public class AverageWaitingTime {
    ...
    public static double averageWaitingTime(int[][] customers) {
        long totalWaitingTime = customers[0][1], finishTime=customers[0][0]+customers[0][1];
