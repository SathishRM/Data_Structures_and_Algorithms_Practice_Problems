...
class NumberOfWaysToSplitArray:
    def waysToSplitArray(self, nums: list[int]) -> int:
        lSum = nums[0]
        rSum = sum([n for n in nums[1:]])
        result = 1 if lSum >= rSum else 0
...
if __name__ == '__main__':
    numberOfWaysToSplitArray = NumberOfWaysToSplitArray()
    print(numberOfWaysToSplitArray.waysToSplitArray([10,4,-8,7]))