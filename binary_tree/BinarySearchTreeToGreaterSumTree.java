...
public class BinarySearchTreeToGreaterSumTree {
    ...
    // public void inOrderTraversal(TreeNode node, Deque<TreeNode> stack) {
    public static void inOrderTraversal(TreeNode node, List<TreeNode> list) {
        // if(node.left != null) inOrderTraversal(node.left,stack);
        // stack.push(node);

        // if(node.right != null) inOrderTraversal(node.right,stack);
