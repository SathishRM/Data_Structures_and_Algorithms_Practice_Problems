...
For example, "a puppy has 2 eyes 4 legs" is a sentence with seven tokens: "2" and "4" are numbers and
the other tokens such as "puppy" are words.
...
public class CheckIfNumbersAreAscendingInASentence {
    ...
    public static int strToNum(String n) {
        if (n == null || n.equals("")) return 0;
        try {
